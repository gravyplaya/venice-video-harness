...
If you override the video defaults to a non-Seedance family (e.g. Kling / Veo), you can safely revert the image defaults to `nano-banana-pro` + `nano-banana-pro-edit` via `series.json → videoDefaults.imageDefaults`.
